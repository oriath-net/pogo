...
* **Structure** is how much work has been done to determine the structure of
  ...
  * ✅  means that the file can be parsed.
...
* **History** indicates whether the structure is consistent with all release
  ...
  * ✅  means that all historical versions work.
...
* **dat64** indicates whether the file's structure is compatible with dat64
  ...
  * ✅  means that the current dat64 file can be parsed, and yields the same
    results as the legacy dat file.

  * ❌  means that the format is not compatible with dat64, or that dat64
    parsing yields different results.

  * ❓  means that the file was removed before Path of Exile 2.5.0, so no
    dat64 files exist.

## A

| File | Releases | Structure | dat64 | History
| ---- | -------- | --------- | ----- | -------
| AbyssObjects | 3.2- | ❌ | ❌ | ❌
| AbyssRegions | 3.2- | ✅ | ✅ | ✅
| AbyssTheme | 3.2- | ✅ | ✅ | ✅
...
| AtlasExileInfluenceData | 3.9- | ✅ | ❌ | ✅
| AtlasExileInfluenceOutcomes | 3.9- | ✅ | ✅ | ✅
...
| AtlasRegions | 3.9- | ✅ | ✅ | ❌
| AtlasRegionUpgradeRegions | 3.13- | ❌ | ❌ | ❌
| AtlasRegionUpgradesInventoryLayout | 3.13- | ❌ | ❌ | ❌
| AtlasSector | 3.5-3.13 | ✅ | ✅ | ✅
| AtlasSkillGraphs | 3.13- | ❌ | ❌ | ❌
| Attributes | all | ✅ | ✅ | ✅
| AwardDisplay | 3.7- | ✅ | ✅ | ❌
...
| GrantedEffectQualityStats | 3.12- | ❌ | ❌ | ❌
...
| InvasionMonsterRestrictions | 1.1- | ❌ | ❌ | ❌
...
| MicrotransactionGemCategory | 3.14- | ❌ | ❌ | ❌
...
| MiscAnimated | all | ✅ | ✅ | ❌
| MiscAnimatedArtVariations | 3.15- | ❌ | ❌ | ❌
| MiscBeams | 1.3- | ✅ | ❌ | ❌
| MiscBeamsArtVariations | 3.15- | ❌ | ❌ | ❌
| MiscEffectPacks | 3.7- | ✅ | ❌ | ✅
| MiscEffectPacksArtVariations | 3.15- | ❌ | ❌ | ❌
| MiscObjects | all | ✅ | ✅ | ❌
| MiscObjectsArtVariations | 3.15- | ❌ | ❌ | ❌
...
| MonsterTypes | all | ❌ | ❌ | ❌
| MonsterVarieties | all | ❌ | ❌ | ❌
| MonsterVarietiesArtVariations | 3.15- | ❌ | ❌ | ❌
